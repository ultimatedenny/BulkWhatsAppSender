<%@ Page Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false"
    CodeFile="edit.aspx.vb" Inherits="edit" Title="Modify" %>
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="txtUserName">
                        UserName</label>
                    <asp:TextBox ID="txtUserName" class="form-control" placeholder="UserName" Enabled=false   runat="server" autocomplete="off"
